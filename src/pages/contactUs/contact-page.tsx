...
const ConatctDetails: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className="max-w-6xl mx-auto mt-8 md:mt-20 md:p-0 p-3">
                <div className="flex w-100 gap-10 md:gap-20 items-start flex-col md:flex-row">
                    <div className="md:w-2/4 w-full">
                        ...
                        <h1 className='text-[15px] md:text-[17px] leading-7 py-2 md:py-4'>Accinge provides software solutions as well as bespoke software development
                            ...
                            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-2 md:gap-4 py-2">
                                <a href="mailto:info@accinge.com" target="_blank" rel="noopener noreferrer">
                                    <div className="flex items-center">
                                        ...
                                        <div className="text-base text-gray-600 pl-2">info@accinge.com</div>
                                    </div>
                                </a>
                                <div className="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z" /></svg>
                                    <div className="text-base text-gray-600 pl-2">sales@accinge.com</div>
                                </div>
                            </div>
                            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-2 md:gap-4 py-2">
                                <div className="flex items-center">
