                ...
                <div className="max-w-6xl mx-auto py-28 md:py-40">
                    <div className="flex gap-36 items-center p-3 md:px-8 lg:p-0">
                        <div className="relative">
                            ...
                            <svg className="absolute w-full opacity-50 fill-[#957fef] svg-position hidden sm:block" xmlns="http://www.w3.org/2000/svg" id="Layer_1" viewBox="0 0 260 15.6">
                            ...
                            <div className='relative'>
                                <Image src="/static/assets/arrow.svg" alt="Arrow" width={40} height={40} className='absolute arrow-sec' />
                                <input type="text" className='arrow-top drop-shadow-lg shadow-grey-300/50' placeholder='Enter Your Email'/>
                            </div>
