...
const ProductsAndServices: NextPageWithLayout = () => {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 max-w-6xl mx-auto gap-8 padding-adj">
            ...
            <div className="p-8"></div>
            <div className="mt-20 bg-[#fff1fe] h-full md:px-4 md:py-20 padding-adj">
            ...
            <div className="mt-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 max-w-6xl mx-auto gap-8 padding-adj">
                    <SpecialFeature />
                    <SpecialFeature />
                    <SpecialFeature />
                    <SpecialFeature />
