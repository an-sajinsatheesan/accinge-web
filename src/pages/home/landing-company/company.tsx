        ...
        <>
            ...
            <div className="rounded-lg bg-[#f9e3f8] max-w-6xl mx-auto mt-20" >
                <div className="flex flex-col w-full items-center justify-around md:flex-row py-12 px-3 gap-2">
                    ...
                    <div className="w-full sm:w-2/4 md:w-1/3"> <h1 className='text-gray-600 leading-7 mt-3 italic'>
                ...
                <div className="flex w-100 pb-8 items-center justify-center gap-2">
