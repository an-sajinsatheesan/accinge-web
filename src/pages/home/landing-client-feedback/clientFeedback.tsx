                ...
                {/* <div className="max-w-6xl mx-auto">
                    ...
                    <div className="p-3 grid gap-8 md:grid-cols-2 md:p-0">
                        ...
                        <div className='space-y-6 rounded-3xl border border-gray-100 bg-white p-8 shadow-2xl shadow-gray-600/10'>
                            ...
                            <div className="mt-4 leading-7">Their team responded proactively to sudden market demands by offering insightful recommendations and delivering exceptional work.
                        ...
                        <div className='space-y-6 rounded-3xl border border-gray-100 bg-white p-8 shadow-2xl shadow-gray-600/10'>
                            ...
                            <div className="mt-3 leading-7">They displayed amazing reactivity to unanticipated market swings, providing insightful advice and constantly generating work of great quality.
