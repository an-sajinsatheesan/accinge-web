                    ...
                    <div className="flex flex-col md:flex-row h-full md:items-center items-start justify-between gap-6 py-6 md:flex-col md:items-start md:justify-between md:space-y-6 md:border-none md:py-0">
                        <div className='flex flex-col'>
                            ...
                            {/* <div className="flex gap-6 pt-3">
                                <a href="https://www.facebook.com/accinge/" target="blank" aria-label="Facebook" className="hover:text-cyan-900">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512"><path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z" /></svg>

                                </a>
                                <a href="https://www.instagram.com/accingetech/?hl=en" target="blank" aria-label="twitter" className="hover:text-cyan-900">
                                ...
                                <a href="https://www.linkedin.com/company/accinge-technologies-llc/about/" target="blank" aria-label="medium" className="hover:text-cyan-900">
